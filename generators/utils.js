    ...
    jhipsterUtils.rewriteFile(
        {
            ...
            splicable: [
                // prettier-ignore
                `<v-list-item @click="$router.push({name: '${className}'})">
                        <v-list-item-action><font-awesome-icon icon="asterisk" /></v-list-item-action>
                        <v-list-item-title ${menuI18nTitle}>${className}</v-list-item-title>
                    </v-list-item>`
            ]
        },
        generator
